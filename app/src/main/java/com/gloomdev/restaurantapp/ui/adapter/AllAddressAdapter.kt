...
//            binding.root.setBackgroundColor(if (isSelected) Color.LTGRAY else Color.WHITE)
//        }
//    }
//
...
//            sharedPreferences.edit().putString("selectedAddress", note.flat +","+ note.area+","+note.state).apply()
//
...
//    init {
//        // Load the previously selected address value from SharedPreferences
//        val savedAddress = sharedPreferences.getString("selectedAddress", "")
//        selectedPosition = list.indexOfFirst { it.flat == savedAddress }
//    }
init {
